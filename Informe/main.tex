...
%%%%%%% DESCRIPCION Y JUSTIFICACION %%%%%%% INICIO
...
%%%%%%% DESCRIPCION Y JUSTIFICACION %%%%%%% FIN

%%%%%%% DETALLES IMPORTANTES DE LA IMPLEMENTACION %%%%%%% INICIO
...
%%%%%%% DETALLES IMPORTANTES DE LA IMPLEMENTACION %%%%%%% FIN

\newpage
%%%%%%% ANALISIS DE LOS ARBOLES %%%%%%% INICIO
\section{Análisis de los árboles generados por el modelo}

%%%%%%% ANALISIS DE LOS ARBOLES %%%%%%% FIN
\newpage
...
%%%%%%% ANALISIS DE LOS RESULTADOS %%%%%%% INICIO
\section{Análisis de los resultados}

%%%%%%% ANALISIS DE LOS RESULTADOS %%%%%%% FIN
